...
/**
 * Describes the runtime environment (Matomo/PHP/MySQL versions, install size, release channel)
 * used when resolving plugin dependencies.
 *
 * selfwatch note: this class used to live in the (now removed) Marketplace plugin, but the
 * plugin dependency checker in {@see Dependency} needs it, so it lives in core.
 */
class Environment
{
    /**
